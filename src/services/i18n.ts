...
const i18Obj: Record<Lang, Record<string, string>> = {
  ru: {
    ...
    "about-card-0-desc": "Прямая работа с производителем обеспечивает постоянное наличие всех видов металлопроката",
    "about-card-1-title": "Собственный автопарк",
    "about-card-1-desc": "Автомобили грузоподъёмностью от 1.5 до 20 тонн. Всегда быстрая доставка.",
    "about-card-2-title": "Объёмы поставок",
    "about-card-2-desc": "Собственная служба доставки гарантирует вам поставку материалов на объект в кратчайшие сроки.",
    "about-card-3-title": "Справедливая цена",
    "about-card-3-desc": "Собственные ресурсы и транспорт позволяют снижать стоимость.",
    "about-card-4-title": "Обработка заявки < 30 минут",
    "about-card-4-desc": "Отдел продаж, насчитывающий более 80 сотрудников, не оставит вашу заявку без внимания.",
    "about-card-5-title": "Погрузка без очередей",
    "about-card-5-desc": "Развитая складская логистика позволяет отгружать продукцию всегда без очередей.",
    // Catalog
    ...
    "catalog-error": "Не удалось загрузить каталог. Убедитесь, что JSON Server запущен (npm run server).",
    // Contact form
    "contact-heading": "ЕСТЬ ВОПРОСЫ?",
    "contact-desc": "Если у Вас есть вопросы или требуется помощь в подборе кровельных материалов, то оставьте свои данные, мы свяжемся с Вами и проконсультируем.",
    ...
    // Testimonials
    "testimonials-heading": '<span class="gradient-text">ЛУЧШЕ ВСЕГО О НАС</span><br>РАССКАЖУТ НАШИ КЛИЕНТЫ',
    ...
    "auth-nickname-hint": "Сгенерирован автоматически. Не нравится — нажмите «Другой».",
    "auth-nickname-input-placeholder": "Введите свой никнейм",
    "auth-nickname-limit": "Лимит автогенераций исчерпан — введите никнейм вручную.",
    ...
    "cart-checkout-thanks": "Спасибо! Мы свяжемся с вами для подтверждения заказа.",
    // Account page
    ...
    "account-logout-desc": "После выхода защищённые разделы (корзина, избранное, отзывы, страницы товаров) снова станут недоступны. Личные данные останутся сохранены.",
    ...
    "favorites-empty-desc": "Нажмите на сердечко в карточке товара — он появится здесь.",
    ...
    "reviews-empty-desc": "Попробуйте изменить параметры фильтрации или поиска.",
    "reviews-reset": "Сбросить фильтры",
    "reviews-loading": "Загрузка отзывов...",
    "reviews-error": "Не удалось загрузить отзывы. Проверьте, что JSON Server запущен.",
    ...
    "footer-reset-confirm": "Сбросить все настройки и выйти?\nБудут удалены: корзина, избранное, аккаунт.",
    // About company page
    "company-home": "На главную",
    "company-label": "О компании",
    "company-heading": "МЕТАЛЛОБАЗА ВОЛХОНКА",
    "company-desc": "С 2010 года поставляем кровельные и фасадные материалы для частных домов, коммерческих объектов и промышленных предприятий по всей Северо-Западу. Работаем напрямую с заводами-изготовителями — это значит честные цены, контроль качества и поставки в срок.",
    ...
    "company-mission-desc": "Мы верим, что надёжная кровля и фасад не должны стоить как премиальная иномарка. Поэтому мы убираем посредников, держим собственный склад и автопарк, автоматизируем расчёты — и передаём экономию клиенту. Чтобы у каждого был выбор: купить дешевле без потери качества или получить премиальный материал по справедливой цене.",
    "company-values-heading": "Наши принципы",
    "company-value-0-title": "Качество без компромиссов",
    "company-value-0-desc": "Принимаем металл только у производителей с сертификацией. Каждая партия проходит входной контроль на складе.",
    "company-value-1-title": "Прозрачные цены",
    "company-value-1-desc": "Цены в каталоге — финальные. Никаких «уточним при заказе»: вы видите стоимость до копейки ещё на этапе расчёта.",
    "company-value-2-title": "Внимание к клиенту",
    "company-value-2-desc": "Менеджер ведёт заказ от заявки до подписания акта приёмки. Любые вопросы — по одному номеру, без переключений.",
    "company-value-3-title": "Скорость поставки",
    "company-value-3-desc": "Большая часть заказов отгружается в день обращения. Срочные — в течение 2 часов с момента оплаты.",
    "company-timeline-heading": "История компании",
    "company-milestone-0-title": "Основание компании",
    "company-milestone-0-desc": "Открыли первый склад в Горелово площадью 1 500 м². Начали с поставок профнастила и арматуры.",
    "company-milestone-1-title": "Расширение ассортимента",
    "company-milestone-1-desc": "Добавили в каталог металлочерепицу, фальцевую кровлю и доборные элементы. Склад вырос до 8 000 м².",
    "company-milestone-2-title": "Собственный автопарк",
    "company-milestone-2-desc": "Запустили службу доставки: 50 машин грузоподъёмностью от 1,5 до 20 тонн. Сроки доставки сократились до 1–2 дней.",
    "company-milestone-3-title": "Прямые контракты с заводами",
    "company-milestone-3-desc": "Перешли на работу напрямую с производителями, снизив цены для клиентов на 8–15%.",
    "company-milestone-4-title": "Цифровая платформа",
    "company-milestone-4-desc": "Запустили онлайн-каталог с калькулятором стоимости и автоматизацию обработки заявок — менее 30 минут от заявки до счёта.",
    ...
    "company-cta-desc": "Менеджер подберёт материал под ваш бюджет и сроки. Расскажет о текущих ценах, складских остатках и условиях доставки.",
    ...
    "cat-desc-metal-tile": "Современное кровельное покрытие, имитирующее керамическую черепицу. Сочетает эстетику классической кровли с прочностью стали: малый вес, простой монтаж и срок службы до 50 лет. Подходит для скатных крыш частных домов и коммерческих объектов.",
    "cat-desc-corrugated": "Универсальный профилированный лист для кровли, заборов и облицовки фасадов. Высокая жёсткость профиля при малом весе, устойчивость к атмосферным нагрузкам, широкая палитра защитно-декоративных покрытий.",
    "cat-desc-seam": "Премиальная фальцевая кровля со скрытым замковым соединением. Полностью герметичная поверхность без пробитий, эстетичный современный вид, срок службы до 70 лет. Применима на крышах любой геометрии — от плоских до сложных.",
    ...
    "admin-form-error": "Заполните обязательные поля: Название, Цена и URL изображения",
  ...
  en: {
    ...
    "about-desc": "We guarantee every client mutually beneficial terms of cooperation. We value our customers, so defective and low-quality metal never enters our warehouse. With us — reliable, profitable and safe!",
    "about-card-0-title": "Constant availability",
    "about-card-0-desc": "Direct work with the manufacturer ensures constant availability of all types of metal products",
    "about-card-1-title": "Own vehicle fleet",
    "about-card-1-desc": "Vehicles with load capacity from 1.5 to 20 tons. Always fast delivery.",
    "about-card-2-title": "Supply volumes",
    "about-card-2-desc": "Our own delivery service guarantees delivery of materials to your site in the shortest possible time.",
    "about-card-3-title": "Fair price",
    "about-card-3-desc": "Own resources and transport allow us to reduce costs.",
    "about-card-4-title": "Request processing < 30 min",
    "about-card-4-desc": "Our sales department of over 80 employees will never leave your request unattended.",
    "about-card-5-title": "Loading without queues",
    "about-card-5-desc": "Advanced warehouse logistics allows shipping products always without queues.",
    // Catalog
    ...
    "catalog-error": "Failed to load catalog. Make sure JSON Server is running (npm run server).",
    // Contact form
    "contact-heading": "HAVE QUESTIONS?",
    "contact-desc": "If you have questions or need help selecting roofing materials, leave your details and we will contact you for a consultation.",
    "contact-btn": "Get a consultation",
    "contact-messenger": "or message us",
    "contact-thanks": "Thank you! We will contact you shortly.",
    // Testimonials
    "testimonials-heading": '<span class="gradient-text">THE BEST PROOF</span><br>ARE OUR CUSTOMERS',
    ...
    "auth-nickname-hint": "Generated automatically. Don't like it — click «Another».",
    "auth-nickname-input-placeholder": "Enter your nickname",
    "auth-nickname-limit": "Generation limit reached — enter a nickname manually.",
    ...
    "cart-checkout-thanks": "Thank you! We will contact you to confirm the order.",
    // Account page
    "account-home": "Home",
    ...
    "account-logout-desc": "After signing out, protected sections (cart, favorites, reviews, product pages) will become inaccessible again. Your personal data will remain saved.",
    ...
    "favorites-empty-desc": "Click the heart on a product card — it will appear here.",
    ...
    "reviews-error": "Failed to load reviews. Make sure JSON Server is running.",
    ...
    "footer-reset-confirm": "Reset all settings and sign out?\nThis will delete: cart, favorites, account.",
    // About company page
    "company-home": "Home",
    "company-label": "About company",
    "company-heading": "METALLOBASE VOLKHONKA",
    "company-desc": "Since 2010 we have been supplying roofing and facade materials for private homes, commercial facilities and industrial enterprises throughout the Northwest. We work directly with manufacturers — meaning fair prices, quality control and on-time deliveries.",
    ...
    "company-mission-desc": "We believe that reliable roofing and facades should not cost as much as a premium car. That's why we cut out middlemen, maintain our own warehouse and fleet, automate calculations — and pass the savings to the client. So everyone has a choice: buy cheaper without losing quality or get premium material at a fair price.",
    "company-values-heading": "Our principles",
    "company-value-0-title": "Uncompromising quality",
    "company-value-0-desc": "We only accept metal from certified manufacturers. Each batch undergoes incoming inspection at the warehouse.",
    "company-value-1-title": "Transparent pricing",
    "company-value-1-desc": "Prices in the catalog are final. No 'we'll clarify at order': you see the exact cost at the calculation stage.",
    "company-value-2-title": "Customer focus",
    "company-value-2-desc": "A manager handles the order from request to acceptance certificate signing. Any question — one number, no transfers.",
    "company-value-3-title": "Fast delivery",
    "company-value-3-desc": "Most orders ship on the day of request. Urgent ones — within 2 hours of payment.",
    "company-timeline-heading": "Company history",
    "company-milestone-0-title": "Company founded",
    "company-milestone-0-desc": "We opened our first warehouse in Gorelovo, 1,500 m². Started with corrugated sheet and rebar supplies.",
    "company-milestone-1-title": "Assortment expansion",
    "company-milestone-1-desc": "Added metal tiles, seam roofing and accessories to the catalog. Warehouse grew to 8,000 m².",
    "company-milestone-2-title": "Own vehicle fleet",
    "company-milestone-2-desc": "Launched delivery service: 50 vehicles with capacity from 1.5 to 20 tons. Delivery times reduced to 1–2 days.",
    "company-milestone-3-title": "Direct contracts with factories",
    "company-milestone-3-desc": "Switched to working directly with manufacturers, reducing prices for clients by 8–15%.",
    "company-milestone-4-title": "Digital platform",
    "company-milestone-4-desc": "Launched an online catalog with a cost calculator and automated request processing — less than 30 minutes from request to invoice.",
    ...
    "company-cta-desc": "A manager will select materials for your budget and timeline. They'll tell you about current prices, stock levels and delivery terms.",
    ...
    "cat-desc-metal-tile": "A modern roofing covering that mimics ceramic tiles. Combines the aesthetics of classic roofing with the strength of steel: low weight, easy installation, and a service life of up to 50 years. Suitable for pitched roofs of private homes and commercial facilities.",
    "cat-desc-corrugated": "A versatile profiled sheet for roofing, fences and facade cladding. High profile rigidity at low weight, resistance to atmospheric loads, a wide range of protective-decorative coatings.",
    "cat-desc-seam": "Premium seam roofing with a hidden lock joint. Completely waterproof surface without penetrations, elegant modern look, service life up to 70 years. Applicable on roofs of any geometry — from flat to complex.",
...
export const getTranslate = (lang: Lang): void => {
  ...
  document.querySelectorAll<HTMLElement>("[data-i18n-surface]").forEach((el) => {
  ...
  document.querySelectorAll<HTMLElement>("[data-i18n-title]").forEach((el) => {
    ...
    el.textContent = lang === "en" ? (PRODUCT_TITLE_EN[russianTitle] ?? russianTitle) : russianTitle;
  });
};
