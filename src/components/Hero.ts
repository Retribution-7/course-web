export const Hero = (): string => {
  return `
    <section class="relative min-h-[961px] overflow-hidden" aria-label="Главный баннер">
      ...
      <div class="container-main relative z-10 pt-[267px] pb-[147px]">

        <div class="flex flex-col gap-[43px] max-w-[899px]">

          <h1 class="font-sans font-normal text-[56px] leading-[68px] text-[#303030]">
            ПРОДАЖА кровельных материалов
            <span class="gradient-text">с доставкой<br>по Санкт-Петербургу<br>и области</span>
            в день заказа
          </h1>

          <p class="font-sans text-[22px] leading-[1.3] text-black max-w-[434px]">
          ...
          <div>
            <button
              class="btn-primary text-[22px] px-[46px] py-9"
      ...
      <div class="absolute right-0 top-[267px] bottom-[147px] z-10 hidden lg:flex flex-col justify-center gap-[10px] w-[110px]"
        ...
        <button
          ...
          <img src="/icons/block.svg" alt="" aria-hidden="true" class="w-[37px] h-[36px] object-contain">
