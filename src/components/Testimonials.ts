...
const reviews: Review[] = [
  {
    name: "Serg",
    date: "27.07.2022",
    avatar: "/images/peoples/people-1.jpg",
  ...
  },
  {
    name: "Квартира дом",
    date: "21.01.2022",
    avatar: "/images/peoples/people-2.png",
...
export const Testimonials = (): string => {
  return `
    <section class="bg-[#F7F9FD] py-[100px]" id="testimonials" aria-labelledby="testimonials-heading">
      <div class="container-main flex flex-col gap-[29px]">

        <!-- Заголовок + кнопки навигации -->
        <div class="flex items-start justify-between gap-6">
          <div class="flex-1">
            <h2 id="testimonials-heading" class="font-sans font-normal text-[56px] leading-[68px]">
